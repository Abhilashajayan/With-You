    ...
    <>  
        <div className="flex items-center justify-center bg-white min-h-screen">
             <div className="w-full max-w-md p-8  rounded ">
                 ...
                 <h2 className="text-lg   text-black text-center">Sign up to continue</h2>
                <div className=" flex justify-center p-5">
                   <button className="text-white bg-gradient-to-br from-pink-500 to-orange-400 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-pink-200 dark:focus:ring-pink-800 font-medium rounded-lg w-full text-sm px-5 py-2.5 text-center me-2 ">
                        Continue with email
                     </button>
                 </div>
